...
// Es hora de poner en práctica lo visto hasta ahora. Si bien parece que usar fetch es sencillo, veamos de hacerlo al menos una vez.
// Para eso vamos a tener que:
// 1) Escribir la función de un fetch que ejecute un GET en la URL: 'https://api.chucknorris.io/jokes/random'.
...
// Session storage
// Nos piden que creemos en sessionStorage un item con el nombre "bgColor" con el valor "red" para que desde otro script puedan cambiar el color del body. Además, nos piden que eliminemos el item "font".
window.addEventListener('load', function(){
